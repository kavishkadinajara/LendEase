...
export default function RegisterPage() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8  bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#090b1c] via-[#070015] to-black z-50 shadow-2xl shadow-indigo-900">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <button
            ...
            type="submit"
          >
            <IconBrandGoogle className="h-4 w-4 text-neutral-300 text-center" />
