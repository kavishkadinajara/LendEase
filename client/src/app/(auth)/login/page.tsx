            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-x-36 p-4 md:p-8">
                <div className="flex justify-center md:justify-start" >
                    <div className="relative mx-auto hidden md:block">
                        ...
                        <img
                            src={"logo.png"}
                            alt="hero"
                            className="max-w-full md:max-w-screen-sm z-10 fade-edges mx-auto w-full md:w-[530px] rounded-2xl shadow-2xl shadow-purple-950"
                        />
                    </div>
                </div>
                ...
                <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#090b1c] via-[#070015] to-black z-50 shadow-2xl shadow-purple-950">
                  ...
                  <form className="my-8" onSubmit={handleSubmit}>
                    ...
                    <button
                      className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md mt-8 h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
                      type="submit"
                    >
                      Sign in &rarr;
                      <BottomGradient />
